...
the Elf showed you 20 red cubes at once; similarly, game 4 would also 
...
def sum_id_of_the_valid_game(map_game_list, counter):
...
def sum_powers_of_minimum_sets(map_game_list, counter):
    for key, value in map_game_list.items():
...
sum_id_of_the_valid_game(map_game_list, counter)
sum_powers_of_minimum_sets(map_game_list, counter)
